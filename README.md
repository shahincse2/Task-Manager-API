...
- ১. সার্ভার পোর্ট (যে পোর্টে আপনার ব্যাকএন্ড রান হবে)
- ২. মঙ্গোডিবি কানেকশন লিংক (লোকাল পিসির জন্য নিচের লিংকটি ব্যবহার করুন)
- ৩. JWT টোকেন এনক্রিপশন কি (যেকোনো একটি সিক্রেট পাসওয়ার্ড বা র্যান্ডম টেক্সট লিখুন)
- ৪. মেইলট্র্যাপ (Mailtrap) ক্রেডেনশিয়ালস (ওটিপি এবং পাসওয়ার্ড রিকভারি ইমেইল টেস্ট করার জন্য)
